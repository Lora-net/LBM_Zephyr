...
// clang-format on
	...
	#define SMTC_MODEM_HAL_TRACE_ARRAY(msg, array, len) smtc_modem_hal_print_trace_array_inf(msg, array, len);
	#define SMTC_MODEM_HAL_TRACE_PACKARRAY(msg, array, len) SMTC_MODEM_HAL_TRACE_ARRAY(msg, array, len);
		...
		#define SMTC_MODEM_HAL_TRACE_ARRAY_DEBUG(msg, array, len)	smtc_modem_hal_print_trace_array_dbg(msg, array, len);
