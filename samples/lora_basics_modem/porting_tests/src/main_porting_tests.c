...
static int expected_fw_version(const struct device *transceiver) {
#if defined( LR11XX )
    switch (lora_transceiver_get_model(transceiver)) {
    case LR11XX_SYSTEM_VERSION_TYPE_LR1110: return 0x0401;
    case LR11XX_SYSTEM_VERSION_TYPE_LR1120: return 0x0201;
    case LR11XX_SYSTEM_VERSION_TYPE_LR1121: return 0x0103;
    default: return -1;
    }
#else
    return -1;
...
static bool porting_test_spi( void )
{
    SMTC_HAL_TRACE_MSG( "---------------------------------------- porting_test_spi : " );

    uint16_t counter_nok = 0;

    int fw_version_expected = expected_fw_version(transceiver);
...
static bool porting_test_radio_irq( void )
{
    SMTC_HAL_TRACE_MSG( "---------------------------------------- porting_test_radio_irq : " );
...
static bool porting_test_get_time( void )
{
    SMTC_HAL_TRACE_MSG( "---------------------------------------- porting_test_get_time : \n" );
...
static bool porting_test_timer_irq( void )
{
    SMTC_HAL_TRACE_MSG( "---------------------------------------- porting_test_timer_irq : " );
...
static bool porting_test_stop_timer( void )
{
    SMTC_HAL_TRACE_MSG( "---------------------------------------- porting_test_stop_timer : " );
...
static bool porting_test_disable_enable_irq( void )
{
    SMTC_HAL_TRACE_MSG( "---------------------------------------- porting_test_disable_enable_irq : " );
...
static bool porting_test_random( void )
{
    ...
    SMTC_HAL_TRACE_MSG( "---------------------------------------- porting_test_random : \n" );
...
static bool porting_test_config_rx_radio( void )
{
    SMTC_HAL_TRACE_MSG( "---------------------------------------- porting_test_config_rx_radio :" );
...
static bool porting_test_config_tx_radio( void )
{
    SMTC_HAL_TRACE_MSG( "---------------------------------------- porting_test_config_tx_radio :" );
...
static bool porting_test_sleep_ms( void )
{
    SMTC_HAL_TRACE_MSG( "---------------------------------------- porting_test_sleep_ms :" );
...
static bool porting_test_timer_irq_low_power( void )
{
    SMTC_HAL_TRACE_MSG( "---------------------------------------- porting_test_timer_irq_low_power : " );
...
{
    bool ret = true;
    SMTC_HAL_TRACE_MSG( "---------------------------------------- porting_test_flash : \n" );
